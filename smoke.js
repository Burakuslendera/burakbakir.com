...
(function webpackUniversalModuleDefinition(root, factory, define) {
  ...
  return (function (modules) {
    ...
    return __webpack_require__((__webpack_require__.s = "smoke.js"));
  })({
    /***/ "./assets/dither.png":
      /*!***************************!*\
      !*** ./assets/dither.png ***!
    ...
    /***/ "defaults.js": /***/ function (module, exports, __webpack_require__) {
      "use strict";
        ...
        function activator(canvas, webGL, colorFormat, PROGRAMS, pointers) {
          ...
          function applyBloom(source, destination) {
            ...
            webGL.uniform3f(
              ...
              0.0,
              0.0,
              1.0 // Işık yönü (Z ekseninde yukarıdan aydınlatma)
            );
            webGL.uniform3f(
        ...
        const GLProgram = (function () {
          function GLProgram(vertexShader, fragmentShader, webGL) {
            ...
            for (let i = 0; i < uniformCount; i++) {
              let uniformName = webGL.getActiveUniform(this.program, i).name;
